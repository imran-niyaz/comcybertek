...
public class AmazonTestCase {
    ...
    public void testDefaultValue(){
      ...
      //get the current selected option
        String slectedOptions = allDepartments.getFirstSelectedOption().getText();
      //verify that default dropdown option is all.
        Assert.assertEquals(slectedOptions,"All departments");
    }
    ...
    public void testSortAlphabetical(){
      ...
      //  for(WebElement options : allDepartments.getOptions()){
       // }
    ...
    @Test
    public void testMainDepartment(){
